...
<br><br>
	<h1>Edit Category</h1>
	<hr>
	<form action="EditCategoryFromDB" method="post">
	<input type="hidden" name="id" value="${currCat.getId()}">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<input name="categoryName" value="${currCat.getName()}" 
					class="form-control"
						placeholder="Enter Category Name" autofocus="autofocus">
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-lg-8">
					<textarea name="categoryDescription" value="${currCat.getDescription()}"
					 class="form-control"
